            ...
            <div class="form-group">
                ...
                <div class="level-options">
                    <label class="radio-label">
                        <input type="radio" name="role" value="desa" {{ old('role') == 'desa' ? 'checked' : '' }}> Desa
                    </label>
                    <label class="radio-label">
                        <input type="radio" name="role" value="kecamatan" {{ old('role') == 'kecamatan' ? 'checked' : '' }}> Kecamatan
                    </label>
                    <label class="radio-label">
                        <input type="radio" name="role" value="kabupaten" {{ old('role') == 'kabupaten' ? 'checked' : '' }}> Kabupaten
                    </label>
                </div>
            </div>
...
<!-- ========== MODAL KONTAK - 1 ADMIN DPMD ========== -->
<div id="contactModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <h3><i class="fas fa-address-card"></i> Hubungi Admin DPMD</h3>
            <button class="close-modal" onclick="closeContactModal()">&times;</button>
        </div>
        
        <div class="contact-card" onclick="openWhatsApp('62895373073738', 'Halo Admin DPMD, saya ingin bertanya tentang IDM Digital.')">
            <div class="contact-icon"><i class="fas fa-headset"></i></div>
            <div class="contact-info">
                <strong>Admin DPMD Kabupaten</strong>
                <div class="contact-role">Dinas Pemberdayaan Masyarakat dan Desa</div>
                <div class="contact-number"><i class="fab fa-whatsapp"></i> 0895-3730-73738</div>
            </div>
            <button class="whatsapp-btn" onclick="event.stopPropagation(); openWhatsApp('62895373073738', 'Halo Admin DPMD, saya ingin bertanya tentang IDM Digital.')">
